...
Итак, если вы дошли до этого места, то это значит, что вы теперь приобрели некоторые знания о нескольких (не всех) функциях редактирования кода в редакторе «Visual Studio Code». Но не останавливайтесь на этом :) У нас есть много дополнительных материалов: [документация](https://code.visualstudio.com/docs), [вводные видео](https://code.visualstudio.com/docs/getstarted/introvideos) и статья «[Советы и хитрости](https://code.visualstudio.com/docs/getstarted/tips-and-tricks)» из документации, которые помогут вам научиться пользоваться редактором. А пока вы еще находитесь здесь, вот несколько дополнительных штук, которые вы можете попробовать:

* Откройте встроенную в редактор консоль (терминал) с помощью комбинации клавиш «__Ctrl+\`__» (вторая клавиша в комбинации&nbsp;— [машинописный обратный апостроф](https://ru.wikipedia.org/wiki/Машинописный_обратный_апостроф), по-английски «[backtick](https://en.wikipedia.org/wiki/Backtick)»), а затем ознакомьтесь с тем, что можно делать в редакторе с ее помощью, просмотрев статью «[Встроенный терминал](https://code.visualstudio.com/docs/editor/integrated-terminal)» документации редактора;
* Начните работу с системой контроля версий, нажав комбинацию клавиш «__Ctrl+Shift+G__». Разберитесь, как добавить файлы в индекс (stage), создать коммит (зафиксировать изменения), работать с ветками проекта, просматривать разницы между версиями файлов (diffs) и в других понятиях контроля версий, ознакомившись со статьей «[Использование системы контроля версий в редакторе VS Code](https://code.visualstudio.com/docs/editor/versioncontrol)» документации редактора;
* Загляните в список расширений редактора (их там тысячи) во встроенной в редактор галерее расширений, нажав комбинацию клавиш «__Ctrl+Shift+X__». Статья «[Магазин расширений](https://code.visualstudio.com/docs/editor/extension-marketplace)» документации редактора объяснит вам, как просмотреть самые популярные расширения, как отключить установленные в ваш экземпляр редактора расширения и многое другое.

На этом пока всё.

Счастливого написания кода! <span title="Хлопушка (эмодзи)">:tada:</span>
